...
function badgeClass(r) { return r==='Bajo'?'badge-bajo':r==='Medio'?'badge-medio':'badge-alto'; }
...
function renderCards(data) {
  ...
  grid.innerHTML = data.map(e => `
    <article class="strat-card" tabindex="0" role="button" aria-label="Ver ${e.nombre}">
      ...
      <div class="card-author"><div class="avatar">${initials(e.autor)}</div>${e.autor}</div>
  ...
  box.innerHTML = `
    ...
    <div class="tab-content active" id="content-overview">
      <div class="detail-metrics">
        ...
        <div class="metric"><div class="metric-label">Categoría de riesgo</div><div class="metric-val" style="font-size:16px">${e.categoria_riesgo}</div></div>
      </div>
...
function publishStrategy() {
  ...
  const nueva={id:estrategias.length+1,nombre,autor,categoria_riesgo:riesgo,precio:parseFloat(precio.toFixed(2)),rentabilidad_historica:parseFloat(rent.toFixed(1)),descripcion:desc,tags:['Nueva'],rating:5.0,reviews_count:0,historico:[rent],reviews:[]};
